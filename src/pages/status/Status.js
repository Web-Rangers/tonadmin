...
import LiteserverStatus from './components/LiteserverStatus';
...
export default function StatusPage() {
    ...
    useEffect(async () => {
        ...
        const onTransaction = async (shortTx) => {
            // console.log('TX ' + Object.keys(shortTx));
            setTransactions(transactions => [...transactions, shortTx]);
        }
    ...
    class BlocksStorageImpl {
        ...
        async insertBlocks(mcBlockNumber, shardBlockNumbers) {
            ...
            setBlocks(blocks => [...blocks, mcBlockNumber]);
